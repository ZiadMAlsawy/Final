...
YoloModel = load_model("Models/best_modelVGG19_fixed5.keras") # This Will Be Changed
...
def process_image(input_path, output_path, checked_value):
    ...
    border_color = (0, 0, 0)  
    border_thickness = 5  
    cv2.putText(image, predicted_class, (x, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
...
#             cv2.putText(resized_image, predicted_label, (int(x1), int(y1) - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 0, 0), 2)
